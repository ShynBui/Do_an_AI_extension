...
document = TextLoader(
    os.path.join(current_directory,'data/22.8.2022-So-tay-SV-2022-2.txt'), encoding= 'utf-8'
).load()

# text_splitter = CharacterTextSplitter.from_huggingface_tokenizer(
#     AutoTokenizer.from_pretrained('ShynBui/vie_qa', token= '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'), chunk_size=512, chunk_overlap=0
# )
...
#question-anwsering
from transformers import pipeline
question_answerer = pipeline("question-answering", model="ShynBui/vie_qa",
                             tokenizer="ShynBui/vie_qa")
...
#PhoBert
rdrsegmenter = py_vncorenlp.VnCoreNLP(annotators=["wseg"], save_dir='d:/quanlysinhvien_aiextension/saleapp')
